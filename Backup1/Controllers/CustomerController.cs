...
namespace FastQ.Web.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public CustomerController()
        {
            ...
            _booking = new BookingService(appts, customers, queues, locations, clock, notifier);
        ...
        public ActionResult Book(string queueId, string phone, string firstName, string lastName)
        {
            ...
            var res = _booking.BookFirstAvailable(DefaultLocationId, qId, phone, true, name);
            if (!res.Ok)
            {
        ...
        public JsonResult GetAppointmentSnapshot(string appointmentId)
        {
            ...
            var dto = _queries.GetAppointmentSnapshot(apptId);
            if (dto == null)
        ...
        public JsonResult CancelAppointment(string appointmentId)
        {
            ...
            var res = _booking.Cancel(apptId);
            if (!res.Ok)
