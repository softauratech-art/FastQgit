...
namespace FastQ.Web.Controllers
{
    public class ReportingController : Controller
    {
        ...
        public JsonResult ReportingSnapshot(string locationId, string queueId)
        {
            ...
            var appointments = CompositionRoot.Reporting.ListAppointments(hasLocation ? locId : (Guid?)null).ToList();
            ...
            var providers = CompositionRoot.Reporting.ListProviders(hasLocation ? locId : (Guid?)null);
            ...
            var queues = CompositionRoot.Reporting.ListQueues(hasLocation ? locId : (Guid?)null);
