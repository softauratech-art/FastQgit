...
namespace FastQ.Data.Repositories
{
    public interface IServiceTransactionRepository
    {
        ...
        long TransferSource(char srcType, long srcId, long targetQueueId, long? targetServiceId, char targetKind, DateTime? targetDateUtc, string refValue, string notes, string stampUser, string sourceAction);
