...
namespace FastQ.Data.Db
{
    public sealed class DbServiceTransactionRepository : IServiceTransactionRepository
    {
        ...
        public void SetServiceTransaction(char srcType, long srcId, string action, string stampUser, string notes, TimeSpan? endTimeLocal)
        {
        ...
        public long CloseAndAddSource(char srcType, long srcId, bool additionalService, long? targetQueueId, long? targetServiceId, char? targetKind, DateTime? targetDate, string refValue, string notes, string stampUser)
        {
            using (var conn = DataAccess.Open())
